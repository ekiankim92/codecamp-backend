...
import { Board } from "./modals/board.model.js";
...
app.get('/boards', async function (req, res, next) { // next 는 다음것도 실행할수 있음
...
app.post('/boards', async function (req, res) { // req 는 프론트에서 보내주는 데이터 값 
